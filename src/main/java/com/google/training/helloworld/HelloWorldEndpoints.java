...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="getSum", path = "getSum", httpMethod = HttpMethod.GET)
	
    public CalculateClass getSum(@Named("first") String name,    @Named("second") String period){ 
    	 
    	return new CalculateClass(name,period);
    }
