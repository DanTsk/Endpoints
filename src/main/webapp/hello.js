...
function enableButtons () {
	...
	btn.onclick=function(){getSum();};
	btn.value="Click me for calculate sum";
}
...
function getSum(){
	...
	console.log(f1 + " " + f2);
	var request = gapi.client.helloworldendpoints.getSum({'first': f1, 'second':f2});
	request.execute(sumCallback);
}
...
function sumCallback(response){
	console.log(response);
	document.getElementById("resulter").innerHTML = response.message;
}
